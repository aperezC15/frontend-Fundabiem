  ...
  data: () => ({
    items: [
      ...
      },
      {
        ...
        description: "Este módulo permite visualizar el reporte de pacientes según el tipo de terapia a la que asistió, y ubicación geográfica (pais, departamento, municipio)",
